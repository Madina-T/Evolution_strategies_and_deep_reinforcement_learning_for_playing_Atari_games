...
class Actor(RLNN):
    ...
    def __init__(self, state_dim, action_dim, max_action, args):
        ...
        self.l1 = nn.Conv2d(state_dim, 32, kernel_size=5, stride=2)
        self.l2 = nn.Conv2d(32, 128, kernel_size=5, stride=2)
        self.l3 = nn.Conv2d(128, action_dim, kernel_size=5, stride=2)
...
class Critic(RLNN):
    def __init__(self, state_dim, action_dim, max_action, args):
        ...
        self.l1 = nn.Conv2d(state_dim + action_dim, 32, kernel_size=5, stride=2)
        self.l2 = nn.Conv2d(32, 128, kernel_size=5, stride=2)
        self.l3 = nn.Conv2d(128, 1, kernel_size=5, stride=2)
...
class CriticTD3(RLNN):
    def __init__(self, state_dim, action_dim, max_action, args):
        ...
        # Q2 architecture
        self.l4 = nn.Conv2d(state_dim + action_dim, 32, kernel_size=5, stride=2)
        self.l5 = nn.Conv2d(32, 128, kernel_size=5, stride=2)
        self.l6 = nn.Conv2d(128, 1, kernel_size=5, stride=2)
...
if __name__ == "__main__":
    ...
    env = wrap_dqn(env)
    print(env.action_space, env.observation_space,env.action_space.n, "    obs")
